...
public abstract class ChunkProviderClassicFlat extends ChunkProviderBase {
	...
	public ChunkProviderClassicFlat(World world, long seed, boolean flag) {
		super();
		this.depthBuffer = new double[256];
		this.worldObj = world;
		this.rand = new Random(seed);
		this.minLimitPerlinNoise = new NoiseGeneratorOctaves(this.rand, 15);
		this.maxLimitPerlinNoise = new NoiseGeneratorOctaves(this.rand, 15);
		this.mainPerlinNoise = new NoiseGeneratorOctaves(this.rand, 9);
		this.surfaceNoise = new NoiseGeneratorPerlin(this.rand, 3);
		this.scaleNoise = new NoiseGeneratorOctaves(this.rand, 8);
		this.depthNoise = new NoiseGeneratorOctaves(this.rand, 14);
		this.forestNoise = new NoiseGeneratorOctaves(this.rand, 7);
