...
public abstract class ChunkProviderExperimental extends ChunkProviderBase {
	...
	public ChunkProviderExperimental(World world, long seed, boolean flag) {
		super();
		...
		this.scaleNoise = new NoiseGeneratorOctaves(this.rand, 5);
		this.depthNoise = new NoiseGeneratorOctaves(this.rand, 6);
