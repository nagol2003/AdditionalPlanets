...
public abstract class APGenTreeBasePolulos extends WorldGenAbstractTree {
	...
	public APGenTreeBasePolulos(boolean notify) {
		super(notify);
	}

	public APGenTreeBasePolulos() {
		this(false);
	...
	public APGenTreeBasePolulos setLogBlock(IBlockState logBlock) {
	...
	public APGenTreeBasePolulos setLeavesBlock(IBlockState leavesBlock) {
	...
	public APGenTreeBasePolulos setTrunkSize(int trunkSize) {
	...
	public APGenTreeBasePolulos setCrownSize(int crownSize) {
	...
	public APGenTreeBasePolulos setNoLeaves(boolean noLeaves) {

		this.noLeaves = noLeaves;
		return this;
	}

	public APGenTreeBasePolulos setTreesCanGenerateOnSand(boolean notOnSand) {
	...
	public APGenTreeBasePolulos setSaplingBlock(IBlockState saplingBlock) {
	...
	public APGenTreeBasePolulos setGenerateFlag(int generateFlag) {
	...
	public APGenTreeBasePolulos setMinTrunkSize(int minTrunkSize) {
	...
	public APGenTreeBasePolulos setMaxTrunkSize(int maxTrunkSize) {
	...
	public APGenTreeBasePolulos setMinCrownSize(int minCrownSize) {
	...
	public APGenTreeBasePolulos setMaxCrownSize(int maxCrownSize) {
