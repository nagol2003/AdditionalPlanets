...
public abstract class APGenTreeBaseTestTotem extends WorldGenAbstractTree {
	...
	public APGenTreeBaseTestTotem(boolean notify) {
		super(notify);
	}

	public APGenTreeBaseTestTotem() {
		this(false);
	...
	public APGenTreeBaseTestTotem setLogBlock(IBlockState logBlock) {
	...
	public APGenTreeBaseTestTotem setSignBlock(IBlockState signBlock) {
	...
	public APGenTreeBaseTestTotem setLeavesBlock(IBlockState leavesBlock) {
	...
	public APGenTreeBaseTestTotem setTrunkSize(int trunkSize) {
	...
	public APGenTreeBaseTestTotem setCrownSize(int crownSize) {
	...
	public APGenTreeBaseTestTotem setNoLeaves(boolean noLeaves) {

		this.noLeaves = noLeaves;
		return this;
	}

	public APGenTreeBaseTestTotem setTreesCanGenerateOnSand(boolean notOnSand) {
	...
	public APGenTreeBaseTestTotem setSaplingBlock(IBlockState saplingBlock) {
	...
	public APGenTreeBaseTestTotem setGenerateFlag(int generateFlag) {
	...
	public APGenTreeBaseTestTotem setMinTrunkSize(int minTrunkSize) {
	...
	public APGenTreeBaseTestTotem setMaxTrunkSize(int maxTrunkSize) {
	...
	public APGenTreeBaseTestTotem setMinCrownSize(int minCrownSize) {
	...
	public APGenTreeBaseTestTotem setMaxCrownSize(int maxCrownSize) {
