...
public class APGenTotem extends APGenTreeBaseTestTotem {
	...
	public APGenTotem(Block log, Block leaves, Block sign) {
		super();
		this.setLogBlock(log.getDefaultState());
		this.setLeavesBlock(leaves.getDefaultState());
		this.setSignBlock(sign.getDefaultState());
		this.setMinTrunkSize(2);
		this.setMaxTrunkSize(2);
	}

	public APGenTotem setCanGenerateOnSand() {
