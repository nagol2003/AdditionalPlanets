...
public abstract class APGenTreeTrunkShit extends WorldGenAbstractTree {
	...
	public APGenTreeTrunkShit(boolean notify) {
		super(notify);
	}

	public APGenTreeTrunkShit() {
		this(false);
	...
	public APGenTreeTrunkShit setLogBlock(IBlockState logBlock) {
	...
	public APGenTreeTrunkShit setSignBlock(IBlockState signBlock) {
	...
	public APGenTreeTrunkShit setLeavesBlock(IBlockState leavesBlock) {
	...
	public APGenTreeTrunkShit setTrunkSize(int trunkSize) {
	...
	public APGenTreeTrunkShit setCrownSize(int crownSize) {
	...
	public APGenTreeTrunkShit setNoLeaves(boolean noLeaves) {

		this.noLeaves = noLeaves;
		return this;
	}

	public APGenTreeTrunkShit setTreesCanGenerateOnSand(boolean notOnSand) {
	...
	public APGenTreeTrunkShit setSaplingBlock(IBlockState saplingBlock) {
	...
	public APGenTreeTrunkShit setGenerateFlag(int generateFlag) {
	...
	public APGenTreeTrunkShit setMinTrunkSize(int minTrunkSize) {
	...
	public APGenTreeTrunkShit setMaxTrunkSize(int maxTrunkSize) {
	...
	public APGenTreeTrunkShit setMinCrownSize(int minCrownSize) {
	...
	public APGenTreeTrunkShit setMaxCrownSize(int maxCrownSize) {
