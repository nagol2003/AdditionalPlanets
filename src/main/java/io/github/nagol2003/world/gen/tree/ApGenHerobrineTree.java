...
public class ApGenHerobrineTree extends APGenTreeBaseTestHerobrine {
	...
	public ApGenHerobrineTree setCanGenerateOnSand() {
	...
	public boolean generate (World world, Random rand, BlockPos pos) {
		...
		if (!this.noLeaves) {
			this.placeLogBlock(world, new BlockPos(x + 1, y - 1, z), this.logBlock, this.generateFlag);
			this.placeLogBlock(world, new BlockPos(x - 1, y - 1, z), this.logBlock, this.generateFlag);
			this.placeLeavesBlock(world, new BlockPos(x, y - 1, z - 1), this.leavesBlock, this.generateFlag);
