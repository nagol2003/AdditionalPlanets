...
import io.github.nagol2003.blocks.interfaces.ICustomMesh;
...
public class APRegistry {
	...
	public final static List<Block>       BLOCKS = FilledList.make();
	 ...
	 */
	public void addRegistrationHandler (Consumer<APRegistry> registerFunction, Class<? extends IForgeRegistryEntry<?>> registryClass)
