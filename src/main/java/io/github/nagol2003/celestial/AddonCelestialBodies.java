...
import io.github.nagol2003.celestial.moon.WorldProviderPlanetOneMoon;
import io.github.nagol2003.celestial.planets.planetone.WorldProviderPlanetOne;
import io.github.nagol2003.celestial.planets.planetone.biome.PlanetOneBiomes;
import io.github.nagol2003.celestial.planets.planettwo.WorldProviderPlanetTwo;
import io.github.nagol2003.celestial.spacestation.WorldProviderPlanetTwoStation;
...
public class AddonCelestialBodies {
	...
	private static void registerPlanets_2nd_Task() {
		...
		int x = dim.idPlanetTwo;
		int[] idArray = new int[14];
		...
		ProximaCentauriB.setDimensionInfo(dim.idPlanetTwo, WorldProviderPlanetOne.class);
		...
		AlphaCentauriV.setDimensionInfo(idArray[0], WorldProviderPlanetOne.class);
		...
		AlphaCentaurfour.setDimensionInfo(idArray[1], WorldProviderPlanetOne.class);
		...
		AlphaCentaurtwo.setDimensionInfo(idArray[2], WorldProviderPlanetOne.class);
		...
		AlphaCentaurone.setDimensionInfo(idArray[3], WorldProviderPlanetOne.class);
		...
		planetOne.setDimensionInfo(idArray[4], WorldProviderPlanetOne.class);
		...
		planetTwo.setDimensionInfo(idArray[5], WorldProviderPlanetTwo.class);
		...
		unknownplanet.setDimensionInfo(idArray[6], WorldProviderPlanetOne.class);
		...
		mother.setDimensionInfo(idArray[7], WorldProviderPlanetOne.class);
		...
		Polulos.setDimensionInfo(idArray[8], WorldProviderPlanetOne.class);
		...
		Shayan.setDimensionInfo(idArray[9], WorldProviderPlanetOne.class);
		...
		Denia.setDimensionInfo(idArray[10], WorldProviderPlanetOne.class);
		...
		Ognious.setDimensionInfo(idArray[11], WorldProviderPlanetOne.class);
		...
		Queran.setDimensionInfo(idArray[12], WorldProviderPlanetOne.class);
		...
		Vermon.setDimensionInfo(idArray[13], WorldProviderPlanetOne.class);
	...
	private static void registerMoon_3rd_Task() {
		...
		int mx = incrementalId(dim.idMoon);
		...
		AlphaCentauroneA.setDimensionInfo(mx, WorldProviderPlanetOneMoon.class);
		...
		Erink.setDimensionInfo(mxx, WorldProviderPlanetOneMoon.class);
		...
		Blastopy.setDimensionInfo(mmx, WorldProviderPlanetOneMoon.class);
		...
		Keyian.setDimensionInfo(mmxx, WorldProviderPlanetOneMoon.class);
		...
		Junsin.setDimensionInfo(mmxi, WorldProviderPlanetOneMoon.class);
		...
		Xareious.setDimensionInfo(immx, WorldProviderPlanetOneMoon.class);
		...
		Ammon.setDimensionInfo(ymmx, WorldProviderPlanetOneMoon.class);
		...
		Terrin.setDimensionInfo(mymx, WorldProviderPlanetOneMoon.class);
	...
	private static int incrementalId(int id) {
		return id + 1;
	}
