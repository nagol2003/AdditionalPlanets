//package io.github.nagol2003.celestial.old;
//
...
//		
//		Zakir = new SolarSystem("Zakir", Galaxy.andromeda.getName()).setMapPosition(new Vector3(1.0F, -1.0F, 0.0F));
...
//		
//		unknown = new SolarSystem("unknown", Galaxy.messier81.getName()).setMapPosition(new Vector3(-1.0F, -1.0F, 0.0F));
...
//		
//		Test = new SolarSystem("Test", Galaxy.messier81.getName()).setMapPosition(new Vector3(0.5F, -1.0F, 0.0F));
...
//		
//		BlackHole = new SolarSystem("BlackHole", Galaxy.messier81.getName()).setMapPosition(new Vector3(0.9F, -1.5F, 0.0F));
...
//		
//		V1400Centauri = new SolarSystem("V1400Centauri", Galaxy.andromeda.getName()).setMapPosition(new Vector3(2.5F, -1.1F, 0.0F));
...
//
//		polulosOrbit = new Satellite("space_station.polulos").setParentBody(Polulos);
...
//		polulosOrbit.setTierRequired(Polulos.getTierRequirement());
