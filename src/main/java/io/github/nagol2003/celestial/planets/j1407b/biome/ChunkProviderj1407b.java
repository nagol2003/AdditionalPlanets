...
public class ChunkProviderj1407b extends ChunkProviderAP {

    private final BiomeDecoratorj1407b decorator = new BiomeDecoratorj1407b();
    ...
    public ChunkProviderj1407b(World par1World, long seed, boolean mapFeaturesEnabled) {
