...
public class BiomeProviderj1407b extends BiomeProvider {
	...
	public BiomeProviderj1407b(long seed, WorldType type) {
		this();
		GenLayer[] genLayers = GenLayerj1407b.createWorld(seed);
		this.unzoomedBiomes = genLayers[0];
		this.zoomedBiomes = genLayers[1];
	}

	public BiomeProviderj1407b(World world) {
