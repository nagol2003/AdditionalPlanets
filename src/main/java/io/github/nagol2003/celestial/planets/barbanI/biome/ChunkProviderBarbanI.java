...
public class ChunkProviderBarbanI extends ChunkProviderAP {

    private final BiomeDecoratorBarbanI decorator = new BiomeDecoratorBarbanI();
    ...
    public ChunkProviderBarbanI(World par1World, long seed, boolean mapFeaturesEnabled) {
