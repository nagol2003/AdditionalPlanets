...
public class BiomeVulcanHell extends VulcanBiomes {

	public BiomeVulcanHell(BiomeProperties properties) {
		super(properties);
        this.topBlock = InitBlocks.VULCANDIRT.getDefaultState(); //TODO change this
        this.fillerBlock = InitBlocks.VULCANROCKSCORCHED.getDefaultState(); //TODO change this
