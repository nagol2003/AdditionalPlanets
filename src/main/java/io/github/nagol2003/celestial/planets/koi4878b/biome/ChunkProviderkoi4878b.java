...
public class ChunkProviderkoi4878b extends ChunkProviderAP {

    private final BiomeDecoratorkoi4878b decorator = new BiomeDecoratorkoi4878b();
    ...
    public ChunkProviderkoi4878b(World par1World, long seed, boolean mapFeaturesEnabled) {
