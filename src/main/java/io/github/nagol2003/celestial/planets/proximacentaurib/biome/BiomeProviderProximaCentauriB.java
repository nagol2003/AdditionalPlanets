...
import io.github.nagol2003.celestial.planets.proximacentaurib.biome.gen.GenLayerProximaCentauriB;
...
public class BiomeProviderProximaCentauriB extends BiomeProvider {
	...
	protected BiomeProviderProximaCentauriB() {
		this.body = AddonCelestialBodies.ProximaCentauriB;
		this.biomeCache = new BiomeCache(this);
		this.biomesToSpawnIn = new ArrayList<>();
	}

	public BiomeProviderProximaCentauriB(long seed, WorldType type) {
		this();
		GenLayer[] genLayers = GenLayerProximaCentauriB.createWorld(seed);
		this.unzoomedBiomes = genLayers[0];
		this.zoomedBiomes = genLayers[1];
	}

	public BiomeProviderProximaCentauriB(World world) {
