...
import io.github.nagol2003.celestial.planets.dark.BiomeDecoratorOther;
import io.github.nagol2003.celestial.planets.dark.biome.gen.BiomeDark;
...
public class DarkBiomes extends BiomeGenBaseGC {

	public static final Biome Dark = new BiomeDark(new BiomeProperties("Dark").setBaseHeight(0.145F).setHeightVariation(0.5F).setRainfall(0.8F));

	protected DarkBiomes(BiomeProperties properties) {
	...
	public void generateBiomeSurface(World worldIn, Random rand, ChunkPrimer chunkPrimerIn, int x, int z,
		...
		IBlockState stoneBlockState = ChunkProviderDark.getStoneBlockState();
