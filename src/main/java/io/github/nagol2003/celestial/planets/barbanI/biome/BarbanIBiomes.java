...
import io.github.nagol2003.celestial.planets.barbanI.BiomeDecoratorOther;
import io.github.nagol2003.celestial.planets.barbanI.biome.gen.BiomeBarbanI;
...
public class BarbanIBiomes extends BiomeGenBaseGC {

	public static final Biome BarbanI = new BiomeBarbanI(new BiomeProperties("BarbanI").setBaseHeight(0.145F).setHeightVariation(0.5F).setRainfall(0.8F));

	protected BarbanIBiomes(BiomeProperties properties) {
	...
	public void generateBiomeSurface(World worldIn, Random rand, ChunkPrimer chunkPrimerIn, int x, int z,
		...
		IBlockState stoneBlockState = ChunkProviderBarbanI.getStoneBlockState();
