...
import io.github.nagol2003.celestial.planets.vermon.biome.gen.GenLayerVermon;
...
public class BiomeProviderVermon extends BiomeProvider {
	...
	protected BiomeProviderVermon() {
		this.body = AddonCelestialBodies.Vermon;
		this.biomeCache = new BiomeCache(this);
		this.biomesToSpawnIn = new ArrayList<>();
	}

	public BiomeProviderVermon(long seed, WorldType type) {
		this();
		GenLayer[] genLayers = GenLayerVermon.createWorld(seed);
		this.unzoomedBiomes = genLayers[0];
		this.zoomedBiomes = genLayers[1];
	}

	public BiomeProviderVermon(World world) {
