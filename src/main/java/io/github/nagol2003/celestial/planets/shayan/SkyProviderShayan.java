package io.github.nagol2003.celestial.planets.shayan;
...
public class SkyProviderShayan extends IRenderHandler {
	...
	public SkyProviderShayan(IGalacticraftWorldProvider ShayanProvider) {
		this.sunSize = 0.5F * ShayanProvider.getSolarSize() * 7;
	...
	public void render(float partialTicks, WorldClient world, Minecraft mc) {
		...
		f10 = this.sunSize;
		mc.renderEngine.bindTexture(SkyProviderShayan.sunTexture);
