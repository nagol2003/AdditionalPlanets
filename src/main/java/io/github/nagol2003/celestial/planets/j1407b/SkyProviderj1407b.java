...
public class SkyProviderj1407b extends IRenderHandler {
	...
	public SkyProviderj1407b(IGalacticraftWorldProvider j1407bProvider) {
		this.sunSize = 0.5F * j1407bProvider.getSolarSize() * 7;
	...
	public void render(float partialTicks, WorldClient world, Minecraft mc) {
		...
		f10 = this.sunSize;
		mc.renderEngine.bindTexture(SkyProviderj1407b.sunTexture);
