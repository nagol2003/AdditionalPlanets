...
public class SkyProviderVermon extends IRenderHandler {
	...
	public SkyProviderVermon(IGalacticraftWorldProvider VermonProvider) {
		this.sunSize = 0.5F * VermonProvider.getSolarSize() * 7;
	...
	public void render(float partialTicks, WorldClient world, Minecraft mc) {
		...
		f10 = this.sunSize;
		mc.renderEngine.bindTexture(SkyProviderVermon.sunTexture);
