...
public class ChunkProviderDark extends ChunkProviderAP {

    private final BiomeDecoratorDark decorator = new BiomeDecoratorDark();
    ...
    public ChunkProviderDark(World par1World, long seed, boolean mapFeaturesEnabled) {
