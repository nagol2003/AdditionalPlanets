...
import io.github.nagol2003.celestial.planets.denia.biome.gen.GenLayerDenia;
...
public class BiomeProviderDenia extends BiomeProvider {
	...
	protected BiomeProviderDenia() {
		this.body = AddonCelestialBodies.Denia;
		this.biomeCache = new BiomeCache(this);
		this.biomesToSpawnIn = new ArrayList<>();
	}

	public BiomeProviderDenia(long seed, WorldType type) {
		this();
		GenLayer[] genLayers = GenLayerDenia.createWorld(seed);
		this.unzoomedBiomes = genLayers[0];
		this.zoomedBiomes = genLayers[1];
	}

	public BiomeProviderDenia(World world) {
