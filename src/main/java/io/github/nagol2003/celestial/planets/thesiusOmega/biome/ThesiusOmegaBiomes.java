...
import io.github.nagol2003.celestial.planets.thesiusOmega.BiomeDecoratorOther;
import io.github.nagol2003.celestial.planets.thesiusOmega.biome.gen.BiomeThesiusOmega;
...
public class ThesiusOmegaBiomes extends BiomeGenBaseGC {

	public static final Biome ThesiusOmega = new BiomeThesiusOmega(new BiomeProperties("ThesiusOmega").setBaseHeight(0.145F).setHeightVariation(0.5F).setRainfall(0.8F));

	protected ThesiusOmegaBiomes(BiomeProperties properties) {
	...
	public void generateBiomeSurface(World worldIn, Random rand, ChunkPrimer chunkPrimerIn, int x, int z,
		...
		IBlockState stoneBlockState = ChunkProviderThesiusOmega.getStoneBlockState();
