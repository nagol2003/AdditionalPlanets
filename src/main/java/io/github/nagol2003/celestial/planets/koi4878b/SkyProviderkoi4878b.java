...
public class SkyProviderkoi4878b extends IRenderHandler {
	...
	public SkyProviderkoi4878b(IGalacticraftWorldProvider koi4878bProvider) {
		this.sunSize = 0.5F * koi4878bProvider.getSolarSize() * 7;
	...
	public void render(float partialTicks, WorldClient world, Minecraft mc) {
		...
		f10 = this.sunSize;
		mc.renderEngine.bindTexture(SkyProviderkoi4878b.sunTexture);
