...
import io.github.nagol2003.celestial.planets.koi4878b.biome.gen.GenLayerkoi4878b;
...
public class BiomeProviderkoi4878b extends BiomeProvider {
	...
	protected BiomeProviderkoi4878b() {
		this.body = AddonCelestialBodies.KOI4878b;
		this.biomeCache = new BiomeCache(this);
		this.biomesToSpawnIn = new ArrayList<>();
	}

	public BiomeProviderkoi4878b(long seed, WorldType type) {
		this();
		GenLayer[] genLayers = GenLayerkoi4878b.createWorld(seed);
		this.unzoomedBiomes = genLayers[0];
		this.zoomedBiomes = genLayers[1];
	}

	public BiomeProviderkoi4878b(World world) {
