...
public class WorldProviderj1407b extends WorldProviderSpace implements ISolarLevel {
    ...
    public Class<? extends BiomeProvider> getBiomeProviderClass() {
        BiomeAdaptive.setBodyMultiBiome(Planets.J1407b);
