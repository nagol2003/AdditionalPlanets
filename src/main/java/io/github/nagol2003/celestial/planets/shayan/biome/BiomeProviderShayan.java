...
import io.github.nagol2003.celestial.planets.shayan.biome.gen.GenLayerShayan;
...
public class BiomeProviderShayan extends BiomeProvider {
	...
	protected BiomeProviderShayan() {
		this.body = AddonCelestialBodies.Shayan;
		this.biomeCache = new BiomeCache(this);
		this.biomesToSpawnIn = new ArrayList<>();
	}

	public BiomeProviderShayan(long seed, WorldType type) {
		this();
		GenLayer[] genLayers = GenLayerShayan.createWorld(seed);
		this.unzoomedBiomes = genLayers[0];
		this.zoomedBiomes = genLayers[1];
	}

	public BiomeProviderShayan(World world) {
