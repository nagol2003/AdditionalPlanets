...
public class SkyProviderAPOrbits extends IRenderHandler {
	...
	public SkyProviderAPOrbits(ResourceLocation planet, boolean renderMoon, boolean renderSun, float sunSize) {
	...
	public void render(float partialTicks, WorldClient world, Minecraft mc) {
		...
		if (this.renderSun) {
			...
			var12 = this.sunSize;
			this.minecraft.renderEngine.bindTexture(SkyProviderAPOrbits.sunTexture);
		...
		if (this.renderMoon) {
			...
			GL11.glColor4f(1.0F, 1.0F, 1.0F, 1.0F);
			var12 = 40.0F;
			this.minecraft.renderEngine.bindTexture(SkyProviderAPOrbits.moonTexture);
