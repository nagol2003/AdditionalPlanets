...
public class ChunkProviderBarbanIII extends ChunkProviderAP {

    private final BiomeDecoratorBarbanIII decorator = new BiomeDecoratorBarbanIII();
    ...
    public ChunkProviderBarbanIII(World par1World, long seed, boolean mapFeaturesEnabled) {
