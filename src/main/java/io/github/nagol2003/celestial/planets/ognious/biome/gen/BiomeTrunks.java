...
import io.github.nagol2003.celestial.planets.ognious.biome.BiomeDecoratorOgnious3;
...
public class BiomeTrunks extends OgniousBiomes {

	public BiomeTrunks(BiomeProperties properties) {
		super(properties);
		...
		this.getBiomeDecorator().treesPerChunk = 15;
	}
	...
	public BiomeDecorator createBiomeDecorator() {
		return new BiomeDecoratorOgnious3();
	}

	protected BiomeDecoratorOgnious3 getBiomeDecorator() {
		return (BiomeDecoratorOgnious3) this.decorator;
	}
