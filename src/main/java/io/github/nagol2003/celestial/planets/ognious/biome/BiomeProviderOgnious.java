...
public class BiomeProviderOgnious extends BiomeProvider {
	...
	protected BiomeProviderOgnious() {
		this.body = AddonCelestialBodies.Ognious;
		this.biomeCache = new BiomeCache(this);
		this.biomesToSpawnIn = new ArrayList<>();
	}

	public BiomeProviderOgnious(long seed, WorldType type) {
		this();
		GenLayer[] genLayers = GenLayerOgnious.createWorld(seed);
		this.unzoomedBiomes = genLayers[0];
		this.zoomedBiomes = genLayers[1];
	}

	public BiomeProviderOgnious(World world) {
