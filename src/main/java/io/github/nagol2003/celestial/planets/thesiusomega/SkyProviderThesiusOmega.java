...
public class SkyProviderThesiusOmega extends IRenderHandler {
	...
	public SkyProviderThesiusOmega(IGalacticraftWorldProvider ThesiusOmegaProvider) {
		this.sunSize = 0.5F * ThesiusOmegaProvider.getSolarSize() * 7;
	...
	public void render(float partialTicks, WorldClient world, Minecraft mc) {
		...
		f10 = this.sunSize;
		mc.renderEngine.bindTexture(SkyProviderThesiusOmega.sunTexture);
