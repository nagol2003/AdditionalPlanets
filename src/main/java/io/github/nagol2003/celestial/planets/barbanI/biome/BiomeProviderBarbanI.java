...
import io.github.nagol2003.celestial.planets.barbanI.biome.gen.GenLayerBarbanI;
...
public class BiomeProviderBarbanI extends BiomeProvider {
	...
	protected BiomeProviderBarbanI() {
		this.body = AddonCelestialBodies.BarbanI;
		this.biomeCache = new BiomeCache(this);
		this.biomesToSpawnIn = new ArrayList<>();
	}

	public BiomeProviderBarbanI(long seed, WorldType type) {
		this();
		GenLayer[] genLayers = GenLayerBarbanI.createWorld(seed);
		this.unzoomedBiomes = genLayers[0];
		this.zoomedBiomes = genLayers[1];
	}

	public BiomeProviderBarbanI(World world) {
