...
public class SkyProviderDenia extends IRenderHandler
{
    ...
    public void render(float partialTicks, WorldClient world, Minecraft mc)
    {
        ...
        WorldProviderDenia gcProvider = null;

        if (world.provider instanceof WorldProviderMoon)
        {
            gcProvider = (WorldProviderDenia) world.provider;
        }
        ...
        var12 = 20.0F;
        FMLClientHandler.instance().getClient().renderEngine.bindTexture(SkyProviderDenia.sunTexture);
     ...
     // Ognious
        ...
        FMLClientHandler.instance().getClient().renderEngine.bindTexture(SkyProviderDenia.planet2);
        ...
        {
            FMLClientHandler.instance().getClient().renderEngine.bindTexture(SkyProviderDenia.planet1);
        }
