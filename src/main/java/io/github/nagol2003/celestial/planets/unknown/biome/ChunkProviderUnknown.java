...
public class ChunkProviderUnknown extends ChunkProviderAP {

    private final BiomeDecoratorUnknown decorator = new BiomeDecoratorUnknown();
    ...
    public ChunkProviderUnknown(World par1World, long seed, boolean mapFeaturesEnabled) {
