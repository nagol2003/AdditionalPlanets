...
public class ChunkProviderMother extends ChunkProviderAP {

    private final BiomeDecoratorMother decorator = new BiomeDecoratorMother();
    ...
    public ChunkProviderMother(World par1World, long seed, boolean mapFeaturesEnabled) {
