...
public class SkyProviderBarbanI extends IRenderHandler {
	...
	public SkyProviderBarbanI(IGalacticraftWorldProvider BarbanIProvider) {
		this.sunSize = 0.5F * BarbanIProvider.getSolarSize() * 7;
	...
	public void render(float partialTicks, WorldClient world, Minecraft mc) {
		...
		f10 = this.sunSize;
		mc.renderEngine.bindTexture(SkyProviderBarbanI.sunTexture);
