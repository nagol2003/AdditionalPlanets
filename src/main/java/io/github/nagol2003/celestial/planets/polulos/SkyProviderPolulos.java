...
public class SkyProviderPolulos extends IRenderHandler
{
    ...
    private static final ResourceLocation ship = new ResourceLocation(Const.ASSET_PREFIX, "textures/gui/celestialbodies/cov232.png");
    ...
    public void render(float partialTicks, WorldClient world, Minecraft mc)
    {
        ...
        WorldProviderPolulos gcProvider = null;

        if (world.provider instanceof WorldProviderMoon)
        {
            gcProvider = (WorldProviderPolulos) world.provider;
        }
        ...
        FMLClientHandler.instance().getClient().renderEngine.bindTexture(SkyProviderPolulos.planet1);
        ...
        {
            FMLClientHandler.instance().getClient().renderEngine.bindTexture(SkyProviderPolulos.planet2);
        }
