...
public class ChunkProviderZakir extends ChunkProviderAP {

    private final BiomeDecoratorZakir decorator = new BiomeDecoratorZakir();
    ...
    public ChunkProviderZakir(World par1World, long seed, boolean mapFeaturesEnabled) {
