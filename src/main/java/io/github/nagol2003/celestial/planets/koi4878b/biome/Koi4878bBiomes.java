...
import io.github.nagol2003.celestial.planets.koi4878b.BiomeDecoratorOther;
import io.github.nagol2003.celestial.planets.koi4878b.biome.gen.Biomekoi4878b;
...
public class Koi4878bBiomes extends BiomeGenBaseGC {

	public static final Biome koi4878b = new Biomekoi4878b(new BiomeProperties("koi4878b").setBaseHeight(0.145F).setHeightVariation(0.5F).setRainfall(0.8F));

	protected Koi4878bBiomes(BiomeProperties properties) {
	...
	public void generateBiomeSurface(World worldIn, Random rand, ChunkPrimer chunkPrimerIn, int x, int z,
		...
		IBlockState stoneBlockState = ChunkProviderkoi4878b.getStoneBlockState();
