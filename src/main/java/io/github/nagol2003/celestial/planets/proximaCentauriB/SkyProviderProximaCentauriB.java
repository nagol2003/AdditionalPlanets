...
public class SkyProviderProximaCentauriB extends IRenderHandler {
	...
	public SkyProviderProximaCentauriB(IGalacticraftWorldProvider ProximaCentauriBProvider) {
		this.sunSize = 0.5F * ProximaCentauriBProvider.getSolarSize() * 7;
	...
	public void render(float partialTicks, WorldClient world, Minecraft mc) {
		...
		f10 = this.sunSize;
		mc.renderEngine.bindTexture(SkyProviderProximaCentauriB.sunTexture);
