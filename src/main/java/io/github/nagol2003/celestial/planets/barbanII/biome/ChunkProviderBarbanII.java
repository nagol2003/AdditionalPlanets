...
public class ChunkProviderBarbanII extends ChunkProviderAP {

    private final BiomeDecoratorBarbanII decorator = new BiomeDecoratorBarbanII();
    ...
    public ChunkProviderBarbanII(World par1World, long seed, boolean mapFeaturesEnabled) {
