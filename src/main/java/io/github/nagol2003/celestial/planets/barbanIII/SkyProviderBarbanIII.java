...
public class SkyProviderBarbanIII extends IRenderHandler {
	...
	public SkyProviderBarbanIII(IGalacticraftWorldProvider BarbanIIIProvider) {
		this.sunSize = 0.5F * BarbanIIIProvider.getSolarSize() * 7;
	...
	public void render(float partialTicks, WorldClient world, Minecraft mc) {
		...
		f10 = this.sunSize;
		mc.renderEngine.bindTexture(SkyProviderBarbanIII.sunTexture);
