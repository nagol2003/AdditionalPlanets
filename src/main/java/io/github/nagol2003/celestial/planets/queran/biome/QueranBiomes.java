...
import io.github.nagol2003.celestial.planets.queran.BiomeDecoratorOther;
import io.github.nagol2003.celestial.planets.queran.biome.gen.BiomeQueran;
...
public class QueranBiomes extends BiomeGenBaseGC {

	public static final Biome Queran = new BiomeQueran(new BiomeProperties("Queran").setBaseHeight(0.145F).setHeightVariation(0.5F).setRainfall(0.8F));

	protected QueranBiomes(BiomeProperties properties) {
	...
	public void generateBiomeSurface(World worldIn, Random rand, ChunkPrimer chunkPrimerIn, int x, int z,
		...
		IBlockState stoneBlockState = ChunkProviderQueran.getStoneBlockState();
