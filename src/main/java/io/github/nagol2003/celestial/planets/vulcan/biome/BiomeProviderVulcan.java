...
import io.github.nagol2003.celestial.planets.vulcan.biome.gen.GenLayerVulcan;
...
public class BiomeProviderVulcan extends BiomeProvider {
	...
	protected BiomeProviderVulcan() {
		this.body = AddonCelestialBodies.Vulcan;
		this.biomeCache = new BiomeCache(this);
		this.biomesToSpawnIn = new ArrayList<>();
	}

	public BiomeProviderVulcan(long seed, WorldType type) {
		this();
		GenLayer[] genLayers = GenLayerVulcan.createWorld(seed);
		this.unzoomedBiomes = genLayers[0];
		this.zoomedBiomes = genLayers[1];
	}

	public BiomeProviderVulcan(World world) {
