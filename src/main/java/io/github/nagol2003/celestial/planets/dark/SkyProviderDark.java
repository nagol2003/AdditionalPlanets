...
public class SkyProviderDark extends IRenderHandler {
	...
	public SkyProviderDark(IGalacticraftWorldProvider DarkProvider) {
		this.sunSize = 0.5F * DarkProvider.getSolarSize() * 7;
	...
	public void render(float partialTicks, WorldClient world, Minecraft mc) {
		...
		f10 = this.sunSize;
		mc.renderEngine.bindTexture(SkyProviderDark.sunTexture);
