package io.github.nagol2003.celestial.planets.zakir;
...
public class SkyProviderZakir extends IRenderHandler {
	...
	public SkyProviderZakir(IGalacticraftWorldProvider ZakirProvider) {
		this.sunSize = 0.5F * ZakirProvider.getSolarSize() * 7;
	...
	public void render(float partialTicks, WorldClient world, Minecraft mc) {
		...
		f10 = this.sunSize;
		mc.renderEngine.bindTexture(SkyProviderZakir.sunTexture);
