package io.github.nagol2003.celestial.planets.unknown;
...
public class SkyProviderUnknown extends IRenderHandler {
	...
	public SkyProviderUnknown(IGalacticraftWorldProvider UnknownProvider) {
		this.sunSize = 0.5F * UnknownProvider.getSolarSize() * 7;
	...
	public void render(float partialTicks, WorldClient world, Minecraft mc) {
		...
		f10 = this.sunSize;
		mc.renderEngine.bindTexture(SkyProviderUnknown.sunTexture);
