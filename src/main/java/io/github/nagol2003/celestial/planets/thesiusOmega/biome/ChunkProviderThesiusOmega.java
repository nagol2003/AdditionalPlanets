...
public class ChunkProviderThesiusOmega extends ChunkProviderAP {

    private final BiomeDecoratorThesiusOmega decorator = new BiomeDecoratorThesiusOmega();
    ...
    public ChunkProviderThesiusOmega(World par1World, long seed, boolean mapFeaturesEnabled) {
