...
import io.github.nagol2003.celestial.planets.queran.biome.gen.GenLayerQueran;
...
public class BiomeProviderQueran extends BiomeProvider {
	...
	protected BiomeProviderQueran() {
		this.body = AddonCelestialBodies.Queran;
		this.biomeCache = new BiomeCache(this);
		this.biomesToSpawnIn = new ArrayList<>();
	}

	public BiomeProviderQueran(long seed, WorldType type) {
		this();
		GenLayer[] genLayers = GenLayerQueran.createWorld(seed);
		this.unzoomedBiomes = genLayers[0];
		this.zoomedBiomes = genLayers[1];
	}

	public BiomeProviderQueran(World world) {
