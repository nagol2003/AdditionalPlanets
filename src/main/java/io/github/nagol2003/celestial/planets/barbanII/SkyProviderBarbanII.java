...
public class SkyProviderBarbanII extends IRenderHandler {
	...
	public SkyProviderBarbanII(IGalacticraftWorldProvider BarbanIIProvider) {
		this.sunSize = 0.5F * BarbanIIProvider.getSolarSize() * 7;
	...
	public void render(float partialTicks, WorldClient world, Minecraft mc) {
		...
		f10 = this.sunSize;
		mc.renderEngine.bindTexture(SkyProviderBarbanII.sunTexture);
