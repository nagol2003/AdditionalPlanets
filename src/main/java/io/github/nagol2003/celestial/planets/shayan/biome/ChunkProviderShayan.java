...
public class ChunkProviderShayan extends ChunkProviderAP {

    private final BiomeDecoratorShayan decorator = new BiomeDecoratorShayan();
    ...
    public ChunkProviderShayan(World par1World, long seed, boolean mapFeaturesEnabled) {
