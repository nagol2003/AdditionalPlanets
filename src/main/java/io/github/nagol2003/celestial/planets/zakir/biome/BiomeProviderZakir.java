...
import io.github.nagol2003.celestial.planets.zakir.biome.gen.GenLayerZakir;
...
public class BiomeProviderZakir extends BiomeProvider {
	...
	protected BiomeProviderZakir() {
		this.body = AddonCelestialBodies.ZakirPrime;
		this.biomeCache = new BiomeCache(this);
		this.biomesToSpawnIn = new ArrayList<>();
	}

	public BiomeProviderZakir(long seed, WorldType type) {
		this();
		GenLayer[] genLayers = GenLayerZakir.createWorld(seed);
		this.unzoomedBiomes = genLayers[0];
		this.zoomedBiomes = genLayers[1];
	}

	public BiomeProviderZakir(World world) {
