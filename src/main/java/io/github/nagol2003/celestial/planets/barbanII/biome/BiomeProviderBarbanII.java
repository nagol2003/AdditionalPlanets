...
import io.github.nagol2003.celestial.planets.barbanII.biome.gen.GenLayerBarbanII;
...
public class BiomeProviderBarbanII extends BiomeProvider {
	...
	protected BiomeProviderBarbanII() {
		this.body = AddonCelestialBodies.BarbanII;
		this.biomeCache = new BiomeCache(this);
		this.biomesToSpawnIn = new ArrayList<>();
	}

	public BiomeProviderBarbanII(long seed, WorldType type) {
		this();
		GenLayer[] genLayers = GenLayerBarbanII.createWorld(seed);
		this.unzoomedBiomes = genLayers[0];
		this.zoomedBiomes = genLayers[1];
	}

	public BiomeProviderBarbanII(World world) {
