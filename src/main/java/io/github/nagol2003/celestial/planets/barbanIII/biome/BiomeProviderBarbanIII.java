...
import io.github.nagol2003.celestial.planets.barbanIII.biome.gen.GenLayerBarbanIII;
...
public class BiomeProviderBarbanIII extends BiomeProvider {
	...
	protected BiomeProviderBarbanIII() {
		this.body = AddonCelestialBodies.BarbanIII;
		this.biomeCache = new BiomeCache(this);
		this.biomesToSpawnIn = new ArrayList<>();
	}

	public BiomeProviderBarbanIII(long seed, WorldType type) {
		this();
		GenLayer[] genLayers = GenLayerBarbanIII.createWorld(seed);
		this.unzoomedBiomes = genLayers[0];
		this.zoomedBiomes = genLayers[1];
	}

	public BiomeProviderBarbanIII(World world) {
