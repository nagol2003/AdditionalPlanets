...
import io.github.nagol2003.celestial.planets.dark.biome.gen.GenLayerDark;
...
public class BiomeProviderDark extends BiomeProvider {
	...
	protected BiomeProviderDark() {
		this.body = AddonCelestialBodies.Dark;
		this.biomeCache = new BiomeCache(this);
		this.biomesToSpawnIn = new ArrayList<>();
	}

	public BiomeProviderDark(long seed, WorldType type) {
		this();
		GenLayer[] genLayers = GenLayerDark.createWorld(seed);
		this.unzoomedBiomes = genLayers[0];
		this.zoomedBiomes = genLayers[1];
	}

	public BiomeProviderDark(World world) {
