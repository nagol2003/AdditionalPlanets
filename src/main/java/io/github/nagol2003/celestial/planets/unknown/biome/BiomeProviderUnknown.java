...
import io.github.nagol2003.celestial.planets.unknown.biome.gen.GenLayerUnknown;
...
public class BiomeProviderUnknown extends BiomeProvider {
	...
	protected BiomeProviderUnknown() {
		this.body = AddonCelestialBodies.unknownplanet;
		this.biomeCache = new BiomeCache(this);
		this.biomesToSpawnIn = new ArrayList<>();
	}

	public BiomeProviderUnknown(long seed, WorldType type) {
		this();
		GenLayer[] genLayers = GenLayerUnknown.createWorld(seed);
		this.unzoomedBiomes = genLayers[0];
		this.zoomedBiomes = genLayers[1];
	}

	public BiomeProviderUnknown(World world) {
