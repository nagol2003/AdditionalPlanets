...
import io.github.nagol2003.celestial.planets.mother.biome.gen.GenLayerMother;
...
public class BiomeProviderMother extends BiomeProvider {
	...
	protected BiomeProviderMother() {
		this.body = AddonCelestialBodies.mother;
		this.biomeCache = new BiomeCache(this);
		this.biomesToSpawnIn = new ArrayList<>();
	}

	public BiomeProviderMother(long seed, WorldType type) {
		this();
		GenLayer[] genLayers = GenLayerMother.createWorld(seed);
		this.unzoomedBiomes = genLayers[0];
		this.zoomedBiomes = genLayers[1];
	}

	public BiomeProviderMother(World world) {
