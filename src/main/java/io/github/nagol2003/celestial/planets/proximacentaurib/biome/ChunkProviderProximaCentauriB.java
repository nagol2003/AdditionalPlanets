...
public class ChunkProviderProximaCentauriB extends ChunkProviderAP {

    private final BiomeDecoratorProximaCentauriB decorator = new BiomeDecoratorProximaCentauriB();
    ...
    private static IBlockState stoneBlockState = Blocks.EMERALD_BLOCK.getDefaultState();

    public ChunkProviderProximaCentauriB(World par1World, long seed, boolean mapFeaturesEnabled) {
