...
import io.github.nagol2003.celestial.planets.thesiusomega.biome.gen.GenLayerThesiusOmega;
...
public class BiomeProviderThesiusOmega extends BiomeProvider {
	...
	protected BiomeProviderThesiusOmega() {
		this.body = AddonCelestialBodies.ThesiusOmega;
		this.biomeCache = new BiomeCache(this);
		this.biomesToSpawnIn = new ArrayList<>();
	}

	public BiomeProviderThesiusOmega(long seed, WorldType type) {
		this();
		GenLayer[] genLayers = GenLayerThesiusOmega.createWorld(seed);
		this.unzoomedBiomes = genLayers[0];
		this.zoomedBiomes = genLayers[1];
	}

	public BiomeProviderThesiusOmega(World world) {
