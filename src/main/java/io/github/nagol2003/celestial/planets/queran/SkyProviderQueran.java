package io.github.nagol2003.celestial.planets.queran;
...
public class SkyProviderQueran extends IRenderHandler {
	...
	public SkyProviderQueran(IGalacticraftWorldProvider QueranProvider) {
		this.sunSize = 0.5F * QueranProvider.getSolarSize() * 7;
	...
	public void render(float partialTicks, WorldClient world, Minecraft mc) {
		...
		f10 = this.sunSize;
		mc.renderEngine.bindTexture(SkyProviderQueran.sunTexture);
