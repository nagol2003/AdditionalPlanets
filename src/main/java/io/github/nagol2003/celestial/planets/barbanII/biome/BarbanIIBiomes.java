...
import io.github.nagol2003.celestial.planets.barbanII.BiomeDecoratorOther;
import io.github.nagol2003.celestial.planets.barbanII.biome.gen.BiomeBarbanII;
...
public class BarbanIIBiomes extends BiomeGenBaseGC {

	public static final Biome BarbanII = new BiomeBarbanII(new BiomeProperties("BarbanII").setBaseHeight(0.145F).setHeightVariation(0.5F).setRainfall(0.8F));

	protected BarbanIIBiomes(BiomeProperties properties) {
	...
	public void generateBiomeSurface(World worldIn, Random rand, ChunkPrimer chunkPrimerIn, int x, int z,
		...
		IBlockState stoneBlockState = ChunkProviderBarbanII.getStoneBlockState();
