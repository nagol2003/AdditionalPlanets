...
public class SkyProviderVulcan extends IRenderHandler
{
    private static final ResourceLocation sunTexture = new ResourceLocation(Const.ASSET_PREFIX, "textures/gui/celestialbodies/kanlaon.png");
    ...
    public void render(float partialTicks, WorldClient world, Minecraft mc)
    {
        ...
        WorldProviderVulcan gcProvider = null;

        if (world.provider instanceof WorldProviderMoon)
        {
            gcProvider = (WorldProviderVulcan) world.provider;
        }
        ...
        var12 = 20.0F;
        FMLClientHandler.instance().getClient().renderEngine.bindTexture(SkyProviderVulcan.sunTexture);
