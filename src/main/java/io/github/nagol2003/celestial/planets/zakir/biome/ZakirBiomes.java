...
import io.github.nagol2003.celestial.planets.zakir.BiomeDecoratorOther;
import io.github.nagol2003.celestial.planets.zakir.biome.gen.BiomeZakir;
...
public class ZakirBiomes extends BiomeGenBaseGC {

	public static final Biome Zakir = new BiomeZakir(new BiomeProperties("Zakir").setBaseHeight(0.145F).setHeightVariation(0.5F).setRainfall(0.8F));

	protected ZakirBiomes(BiomeProperties properties) {
	...
	public void generateBiomeSurface(World worldIn, Random rand, ChunkPrimer chunkPrimerIn, int x, int z,
		...
		IBlockState stoneBlockState = ChunkProviderZakir.getStoneBlockState();
