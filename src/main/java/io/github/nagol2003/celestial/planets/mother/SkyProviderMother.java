package io.github.nagol2003.celestial.planets.mother;
...
public class SkyProviderMother extends IRenderHandler {
	...
	public SkyProviderMother(IGalacticraftWorldProvider MotherProvider) {
		this.sunSize = 0.5F * MotherProvider.getSolarSize() * 7;
	...
	public void render(float partialTicks, WorldClient world, Minecraft mc) {
		...
		f10 = this.sunSize;
		mc.renderEngine.bindTexture(SkyProviderMother.sunTexture);
