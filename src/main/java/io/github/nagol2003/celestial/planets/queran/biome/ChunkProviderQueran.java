...
public class ChunkProviderQueran extends ChunkProviderAP {

    private final BiomeDecoratorQueran decorator = new BiomeDecoratorQueran();
    ...
    public ChunkProviderQueran(World par1World, long seed, boolean mapFeaturesEnabled) {
