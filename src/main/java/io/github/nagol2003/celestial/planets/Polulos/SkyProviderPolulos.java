...
public class SkyProviderPolulos extends IRenderHandler {
	 ...
	 private static final ResourceLocation overworldTexture = new ResourceLocation(Const.ASSET_PREFIX, "textures/gui/celestialbodies/denia.png");
	    ...
	    public void render(float partialTicks, WorldClient world, Minecraft mc)
	    {
	        ...
	        WorldProviderOgnious gcProvider = null;

	        if (world.provider instanceof WorldProviderMoon)
	        {
	            gcProvider = (WorldProviderOgnious) world.provider;
	        }
	        ...
	        var12 = 20.0F;
	        FMLClientHandler.instance().getClient().renderEngine.bindTexture(SkyProviderPolulos.sunTexture);
	        ...
	        {
	            FMLClientHandler.instance().getClient().renderEngine.bindTexture(SkyProviderPolulos.overworldTexturetwo);
	        }
	     ...
	     // HOME:
	        var12 = 5.0F;
	        final float earthRotation1 = (float) (world.getSpawnPoint().getZ() - mc.player.posZ) * 0.01F;
	        GL11.glScalef(0.6F, 0.6F, 0.6F);
	        GL11.glRotatef(earthRotation1, 1.0F, 0.0F, 0.0F);
	        GL11.glRotatef(200F, 1.0F, 0.0F, 0.0F);
	        GL11.glColor4f(1.0F, 1.0F, 1.0F, 1F);
	        ...
	        GL11.glDisable(GL11.GL_TEXTURE_2D);
	        GL11.glColor3f(0.0F, 0.0F, 0.0F);
	        final double var251 = mc.player.getPosition().getY() - world.getHorizon();
	        ...
	        GL11.glPushMatrix();
	        GL11.glTranslatef(0.0F, -((float) (var251 - 16.0D)), 0.0F);
	        GL11.glCallList(this.glSkyList2);
	        GL11.glPopMatrix();
	        GlStateManager.enableRescaleNormal();
	        GL11.glEnable(GL11.GL_TEXTURE_2D);
