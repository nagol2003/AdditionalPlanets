...
public class SkyProviderChiona extends IRenderHandler {
	...
	public SkyProviderChiona(IGalacticraftWorldProvider ChionaProvider) {
		this.sunSize = 0.5F * ChionaProvider.getSolarSize() * 7;
	...
	public void render(float partialTicks, WorldClient world, Minecraft mc) {
		...
		f10 = this.sunSize;
		mc.renderEngine.bindTexture(SkyProviderChiona.sunTexture);
