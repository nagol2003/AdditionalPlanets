...
public class SkyProviderKeyian extends IRenderHandler {
	...
	public SkyProviderKeyian(IGalacticraftWorldProvider KeyianProvider) {
		this.sunSize = 0.5F * KeyianProvider.getSolarSize() * 7;
	...
	public void render(float partialTicks, WorldClient world, Minecraft mc) {
		...
		f10 = this.sunSize;
		mc.renderEngine.bindTexture(SkyProviderKeyian.sunTexture);
