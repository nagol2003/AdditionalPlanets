...
public class ChunkProviderXareious extends ChunkProviderAP {

    private final BiomeDecoratorXareious decorator = new BiomeDecoratorXareious();
    ...
    public ChunkProviderXareious(World par1World, long seed, boolean mapFeaturesEnabled) {
