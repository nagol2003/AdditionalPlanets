...
public class ChunkProviderErink extends ChunkProviderAP {

    private final BiomeDecoratorErink decorator = new BiomeDecoratorErink();
    ...
    public ChunkProviderErink(World par1World, long seed, boolean mapFeaturesEnabled) {
