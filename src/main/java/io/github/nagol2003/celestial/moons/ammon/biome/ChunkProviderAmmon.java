...
public class ChunkProviderAmmon extends ChunkProviderAP {

    private final BiomeDecoratorAmmon decorator = new BiomeDecoratorAmmon();
    ...
    public ChunkProviderAmmon(World par1World, long seed, boolean mapFeaturesEnabled) {
