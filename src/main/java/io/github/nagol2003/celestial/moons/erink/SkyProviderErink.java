package io.github.nagol2003.celestial.moons.erink;
...
public class SkyProviderErink extends IRenderHandler {
	...
	public SkyProviderErink(IGalacticraftWorldProvider ErinkProvider) {
		this.sunSize = 0.5F * ErinkProvider.getSolarSize() * 7;
	...
	public void render(float partialTicks, WorldClient world, Minecraft mc) {
		...
		f10 = this.sunSize;
		mc.renderEngine.bindTexture(SkyProviderErink.sunTexture);
