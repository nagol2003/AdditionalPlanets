...
public class SkyProviderTerrin extends IRenderHandler {
	...
	public SkyProviderTerrin(IGalacticraftWorldProvider TerrinProvider) {
		this.sunSize = 0.5F * TerrinProvider.getSolarSize() * 7;
	...
	public void render(float partialTicks, WorldClient world, Minecraft mc) {
		...
		f10 = this.sunSize;
		mc.renderEngine.bindTexture(SkyProviderTerrin.sunTexture);
