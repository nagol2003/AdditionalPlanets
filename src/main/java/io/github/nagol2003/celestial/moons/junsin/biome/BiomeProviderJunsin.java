...
import io.github.nagol2003.celestial.moons.junsin.biome.gen.GenLayerJunsin;
...
public class BiomeProviderJunsin extends BiomeProvider {
	...
	protected BiomeProviderJunsin() {
		this.body = AddonCelestialBodies.Junsin;
		this.biomeCache = new BiomeCache(this);
		this.biomesToSpawnIn = new ArrayList<>();
	}

	public BiomeProviderJunsin(long seed, WorldType type) {
		this();
		GenLayer[] genLayers = GenLayerJunsin.createWorld(seed);
		this.unzoomedBiomes = genLayers[0];
		this.zoomedBiomes = genLayers[1];
	}

	public BiomeProviderJunsin(World world) {
