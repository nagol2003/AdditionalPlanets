...
public class ChunkProviderTerrin extends ChunkProviderAP {

    private final BiomeDecoratorTerrin decorator = new BiomeDecoratorTerrin();
    ...
    public ChunkProviderTerrin(World par1World, long seed, boolean mapFeaturesEnabled) {
