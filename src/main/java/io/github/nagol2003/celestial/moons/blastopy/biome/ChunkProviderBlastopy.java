...
public class ChunkProviderBlastopy extends ChunkProviderAP {

    private final BiomeDecoratorBlastopy decorator = new BiomeDecoratorBlastopy();
    ...
    public ChunkProviderBlastopy(World par1World, long seed, boolean mapFeaturesEnabled) {
