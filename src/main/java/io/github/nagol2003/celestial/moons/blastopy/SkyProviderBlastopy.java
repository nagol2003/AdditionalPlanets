package io.github.nagol2003.celestial.moons.blastopy;
...
public class SkyProviderBlastopy extends IRenderHandler {
	...
	public SkyProviderBlastopy(IGalacticraftWorldProvider BlastopyProvider) {
		this.sunSize = 0.5F * BlastopyProvider.getSolarSize() * 7;
	...
	public void render(float partialTicks, WorldClient world, Minecraft mc) {
		...
		f10 = this.sunSize;
		mc.renderEngine.bindTexture(SkyProviderBlastopy.sunTexture);
