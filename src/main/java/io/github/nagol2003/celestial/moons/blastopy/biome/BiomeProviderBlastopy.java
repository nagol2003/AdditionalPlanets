...
import io.github.nagol2003.celestial.moons.blastopy.biome.gen.GenLayerBlastopy;
...
public class BiomeProviderBlastopy extends BiomeProvider {
	...
	protected BiomeProviderBlastopy() {
		this.body = AddonCelestialBodies.Blastopy;
		this.biomeCache = new BiomeCache(this);
		this.biomesToSpawnIn = new ArrayList<>();
	}

	public BiomeProviderBlastopy(long seed, WorldType type) {
		this();
		GenLayer[] genLayers = GenLayerBlastopy.createWorld(seed);
		this.unzoomedBiomes = genLayers[0];
		this.zoomedBiomes = genLayers[1];
	}

	public BiomeProviderBlastopy(World world) {
