...
public class BiomeProviderChiona extends BiomeProvider {
	...
	public BiomeProviderChiona(long seed, WorldType type) {
		this();
		GenLayer[] genLayers = GenLayerChiona.createWorld(seed);
		this.unzoomedBiomes = genLayers[0];
		this.zoomedBiomes = genLayers[1];
	}

	public BiomeProviderChiona(World world) {
