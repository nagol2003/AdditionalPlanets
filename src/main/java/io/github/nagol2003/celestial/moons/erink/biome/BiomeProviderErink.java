...
import io.github.nagol2003.celestial.moons.erink.biome.gen.GenLayerErink;
...
public class BiomeProviderErink extends BiomeProvider {
	...
	protected BiomeProviderErink() {
		this.body = AddonCelestialBodies.Erink;
		this.biomeCache = new BiomeCache(this);
		this.biomesToSpawnIn = new ArrayList<>();
	}

	public BiomeProviderErink(long seed, WorldType type) {
		this();
		GenLayer[] genLayers = GenLayerErink.createWorld(seed);
		this.unzoomedBiomes = genLayers[0];
		this.zoomedBiomes = genLayers[1];
	}

	public BiomeProviderErink(World world) {
