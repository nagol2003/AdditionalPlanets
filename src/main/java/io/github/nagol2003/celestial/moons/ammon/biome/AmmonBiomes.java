...
import io.github.nagol2003.celestial.moons.ammon.BiomeDecoratorOther;
import io.github.nagol2003.celestial.moons.ammon.biome.gen.BiomeAmmon;
...
public class AmmonBiomes extends BiomeGenBaseGC {

	public static final Biome Ammon = new BiomeAmmon(new BiomeProperties("Ammon").setBaseHeight(0.145F).setHeightVariation(0.5F).setRainfall(0.8F));

	protected AmmonBiomes(BiomeProperties properties) {
	...
	public void generateBiomeSurface(World worldIn, Random rand, ChunkPrimer chunkPrimerIn, int x, int z,
		...
		IBlockState stoneBlockState = ChunkProviderAmmon.getStoneBlockState();
