...
public class ChunkProviderKeyian extends ChunkProviderAP {

    private final BiomeDecoratorKeyian decorator = new BiomeDecoratorKeyian();
    ...
    public ChunkProviderKeyian(World par1World, long seed, boolean mapFeaturesEnabled) {
