...
public class ChunkProviderJunsin extends ChunkProviderAP {

    private final BiomeDecoratorJunsin decorator = new BiomeDecoratorJunsin();
    ...
    public ChunkProviderJunsin(World par1World, long seed, boolean mapFeaturesEnabled) {
