...
import io.github.nagol2003.celestial.moons.xareious.biome.gen.GenLayerXareious;
...
public class BiomeProviderXareious extends BiomeProvider {
	...
	protected BiomeProviderXareious() {
		this.body = AddonCelestialBodies.Xareious;
		this.biomeCache = new BiomeCache(this);
		this.biomesToSpawnIn = new ArrayList<>();
	}

	public BiomeProviderXareious(long seed, WorldType type) {
		this();
		GenLayer[] genLayers = GenLayerXareious.createWorld(seed);
		this.unzoomedBiomes = genLayers[0];
		this.zoomedBiomes = genLayers[1];
	}

	public BiomeProviderXareious(World world) {
