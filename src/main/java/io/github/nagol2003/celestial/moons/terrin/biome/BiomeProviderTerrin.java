...
import io.github.nagol2003.celestial.moons.terrin.biome.gen.GenLayerTerrin;
...
public class BiomeProviderTerrin extends BiomeProvider {
	...
	protected BiomeProviderTerrin() {
		this.body = AddonCelestialBodies.Terrin;
		this.biomeCache = new BiomeCache(this);
		this.biomesToSpawnIn = new ArrayList<>();
	}

	public BiomeProviderTerrin(long seed, WorldType type) {
		this();
		GenLayer[] genLayers = GenLayerTerrin.createWorld(seed);
		this.unzoomedBiomes = genLayers[0];
		this.zoomedBiomes = genLayers[1];
	}

	public BiomeProviderTerrin(World world) {
