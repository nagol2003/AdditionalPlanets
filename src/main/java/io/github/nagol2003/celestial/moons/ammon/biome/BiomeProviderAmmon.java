...
import io.github.nagol2003.celestial.moons.ammon.biome.gen.GenLayerAmmon;
...
public class BiomeProviderAmmon extends BiomeProvider {
	...
	protected BiomeProviderAmmon() {
		this.body = AddonCelestialBodies.Ammon;
		this.biomeCache = new BiomeCache(this);
		this.biomesToSpawnIn = new ArrayList<>();
	}

	public BiomeProviderAmmon(long seed, WorldType type) {
		this();
		GenLayer[] genLayers = GenLayerAmmon.createWorld(seed);
		this.unzoomedBiomes = genLayers[0];
		this.zoomedBiomes = genLayers[1];
	}

	public BiomeProviderAmmon(World world) {
