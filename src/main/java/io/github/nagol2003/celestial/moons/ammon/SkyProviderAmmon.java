package io.github.nagol2003.celestial.moons.ammon;
...
public class SkyProviderAmmon extends IRenderHandler {
	...
	public SkyProviderAmmon(IGalacticraftWorldProvider AmmonProvider) {
		this.sunSize = 0.5F * AmmonProvider.getSolarSize() * 7;
	...
	public void render(float partialTicks, WorldClient world, Minecraft mc) {
		...
		f10 = this.sunSize;
		mc.renderEngine.bindTexture(SkyProviderAmmon.sunTexture);
