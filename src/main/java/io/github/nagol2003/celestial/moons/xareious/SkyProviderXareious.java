...
public class SkyProviderXareious extends IRenderHandler {
	...
	public SkyProviderXareious(IGalacticraftWorldProvider XareiousProvider) {
		this.sunSize = 0.5F * XareiousProvider.getSolarSize() * 7;
	...
	public void render(float partialTicks, WorldClient world, Minecraft mc) {
		...
		f10 = this.sunSize;
		mc.renderEngine.bindTexture(SkyProviderXareious.sunTexture);
