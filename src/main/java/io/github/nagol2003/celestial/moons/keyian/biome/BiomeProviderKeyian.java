...
import io.github.nagol2003.celestial.moons.keyian.biome.gen.GenLayerKeyian;
...
public class BiomeProviderKeyian extends BiomeProvider {
	...
	protected BiomeProviderKeyian() {
		this.body = AddonCelestialBodies.Keyian;
		this.biomeCache = new BiomeCache(this);
		this.biomesToSpawnIn = new ArrayList<>();
	}

	public BiomeProviderKeyian(long seed, WorldType type) {
		this();
		GenLayer[] genLayers = GenLayerKeyian.createWorld(seed);
		this.unzoomedBiomes = genLayers[0];
		this.zoomedBiomes = genLayers[1];
	}

	public BiomeProviderKeyian(World world) {
