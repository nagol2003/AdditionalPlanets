...
public class EntityPigman extends EntityMob
{
    ...
    private static final DataParameter<Boolean> IS_CHILD = EntityDataManager.<Boolean>createKey(EntityPigman.class, DataSerializers.BOOLEAN);
    /**
     * Was the type of villager for zombie villagers prior to 1.11. Now unused. Use {@link
     * EntityZombieVillager#PROFESSION} instead.
     */
    private static final DataParameter<Integer> VILLAGER_TYPE = EntityDataManager.<Integer>createKey(EntityPigman.class, DataSerializers.VARINT);
    private static final DataParameter<Boolean> ARMS_RAISED = EntityDataManager.<Boolean>createKey(EntityPigman.class, DataSerializers.BOOLEAN);
        ...
        if (super.attackEntityFrom(source, amount))
        {
           ...
           //     EntityZombie entityzombie;
             ...
             //   }
                ...
                {
              //      entityzombie = new EntityPigman(this.world);
                }
    ...
    public void onKillEntity(EntityLivingBase entityLivingIn)
    {
        ...
        if ((this.world.getDifficulty() == EnumDifficulty.NORMAL || this.world.getDifficulty() == EnumDifficulty.HARD) && entityLivingIn instanceof EntityVillager)
        {
            ...
            entityzombievillager.onInitialSpawn(this.world.getDifficultyForLocation(new BlockPos(entityzombievillager)), new EntityPigman.GroupData(false));
    ...
    public IEntityLivingData onInitialSpawn(DifficultyInstance difficulty, @Nullable IEntityLivingData livingdata)
    {
        ...
        if (livingdata == null)
        {
            livingdata = new EntityPigman.GroupData(this.world.rand.nextFloat() < net.minecraftforge.common.ForgeModContainer.zombieBabyChance);
        }

        if (livingdata instanceof EntityPigman.GroupData)
        {
            EntityPigman.GroupData entityzombie$groupdata = (EntityPigman.GroupData)livingdata;
