...
public class EntityPigman2 extends EntityPigZombie
{
    ...
    public EntityPigman2(World worldIn)
    {
        super(worldIn);
    ...
    {
        this.targetTasks.addTask(1, new EntityPigman2.AIHurtByAggressor(this));
        this.targetTasks.addTask(2, new EntityPigman2.AITargetAggressor(this));
        this.targetTasks.addTask(3, new EntityAINearestAttackableTarget(this, EntityVillager.class, false));
        this.targetTasks.addTask(4, new EntityAINearestAttackableTarget(this, EntityPig.class, false));
    }
    ...
    {
        EntityLiving.registerFixesMob(fixer, EntityPigman2.class);
    }
    ...
    static class AIHurtByAggressor extends EntityAIHurtByTarget
        {
            public AIHurtByAggressor(EntityPigman2 p_i45828_1_)
            {
            ...
            protected void setEntityAttackTarget(EntityCreature creatureIn, EntityLivingBase entityLivingBaseIn)
            {
                ...
                if (creatureIn instanceof EntityPigman2)
                {
                    ((EntityPigman2)creatureIn).becomeAngryAt(entityLivingBaseIn);
                }
            }
        }
    ...
    static class AITargetAggressor extends EntityAINearestAttackableTarget<EntityPlayer>
        {
            public AITargetAggressor(EntityPigman2 p_i45829_1_)
            {
            ...
            {
                return ((EntityPigman2)this.taskOwner).isAngry() && super.shouldExecute();
            }
        }
