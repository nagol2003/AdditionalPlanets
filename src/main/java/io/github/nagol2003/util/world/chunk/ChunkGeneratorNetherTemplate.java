...
public class ChunkGeneratorNetherTemplate implements IChunkGenerator
{
    ...
    protected static final IBlockState BEDROCK = InitBlocks.ROCK_1.getDefaultState();
    
    //Block that is usually Netherrack
    protected static final IBlockState MAIN_BLOCK = InitBlocks.VULCANROCKSCORCHED.getDefaultState();
    ...
    protected static final IBlockState OTHER_BLOCK1 = InitBlocks.STRANGEMETALLICPOLULOS.getDefaultState();
    protected static final IBlockState OTHER_BLOCK2 = InitBlocks.STRANGEMETALLICDENIA.getDefaultState();
