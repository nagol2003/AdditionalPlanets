...
public class Reflected {
    ...
    public static <T> T getInstance(Constructor<T> constructor, Object... arguments) {
        ...
        } catch (Exception e) { AddonMain.LOGGER.error("Exception creating instance of " + constructor.getClass().getName(), e); }
    ...
    public static Constructor<?> getConstructor(final String className, final Class<?>... argumentTypes) {
        if(className == null || argumentTypes == null) {
            AddonMain.LOGGER.error("The provided class name or arguments can't be null.");
            return null;
        }
        ...
        try {
            ...
            return constructor;
        } catch (Exception ex) { AddonMain.LOGGER.error("Exception getting constructor of " + className, ex); }
    ...
    public static <T> Constructor<T> getConstructor(Class<T> clazz, Class<?>... types) {
        try {
            ...
            constructor.setAccessible(true);
            return constructor;
        } catch (Exception ex) { AddonMain.LOGGER.error("Exception getting constructor of " + clazz.getName(), ex); }
    ...
    public static <T> T getObject(Object object, String... fieldNames) {
        ...
        for (String field : fieldNames) {
            ...
            } catch (Exception ex) { AddonMain.LOGGER.error("Exception in getObject()", ex); }
        }

        AddonMain.LOGGER.error("Could not retrieve any object for the provided field names.");
    ...
    public static <T> T getFinalObject(Object object, String... fieldNames) {
        ...
        for (String field : fieldNames) {
            try {
                ...
                return (T) result.get(object);
            } catch (Exception ex) { AddonMain.LOGGER.error("Exception in getFinalObject()", ex); }
        }
        
        AddonMain.LOGGER.error("Could not retrieve any final object for the provided field names.");
    ...
    public static <T> T getStaticObject(Class<?> clazz, String... fieldNames) {
        for (String field : fieldNames) {
            ...
            } catch (Exception e) { AddonMain.LOGGER.error("Exception in getStaticObject()", e); }
        }
        
        AddonMain.LOGGER.error("Could not retrieve any static object for the provided field names.");
    ...
    public static <T> T getStaticObject(String className, String... fieldNames) {
        ...
        } catch (ClassNotFoundException e) { AddonMain.LOGGER.error("Exception in getStaticObject()", e); }
